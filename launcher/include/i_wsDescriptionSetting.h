#ifndef I_WSDESCRIPTIONSETTING
#define I_WSDESCRIPTIONSETTING

#include <QVariant>
#include "i_wsPtr.h"

class i_wsDescriptionSetting : public virtual i_wsPtr
{
public:
...
Q_DECLARE_INTERFACE(i_wsDescriptionSetting, "ws.launcher.i_wsDescriptionSetting/1.0")

#endif //#ifndef I_DESCRIPTION_SETTING
