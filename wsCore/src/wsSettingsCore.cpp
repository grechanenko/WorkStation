...
struct WSSettingsCore::SDATA
{
	...
	QMutex mutex;						// Для безопасного многопоточного доступа к настройкам
	QSettings* m_settings = Q_NULLPTR;  // Для формирования настроек	
	QList<QTranslator*> m_translators;	// Список загруженных файлов перевода		
